...
EXEC_MENU_ITEMS = {
    ...
    10: {"label": "新增行事曆", "cmd": None, "prompt": "請複製後修改再送出：\n小幫手 新增行事曆 YYYY-MM-DD [HH:MM] 標題 | 備註"},
    11: {"label": "查詢歸檔", "cmd": "查詢歸檔", "prompt": None},
    12: {"label": "新增夥伴", "cmd": None, "prompt": "請複製後修改再送出：\n小幫手 新增夥伴 姓名 | 目標 | 下次跟進日期 | 備註 | 分類"},
    13: {"label": "跟進夥伴", "cmd": None, "prompt": "請複製後修改再送出：\n小幫手 跟進夥伴 姓名 | 狀態 | 下次跟進日期 | 備註"},
    14: {"label": "顯示所有指令", "cmd": "指令集", "prompt": None},
    15: {"label": "421故事歸檔", "cmd": "421故事歸檔", "prompt": None},
    16: {"label": "課程文宣歸檔", "cmd": "課程文宣歸檔", "prompt": None},
