...
檔案：C:\Users\user\claude AI_Agent\agents\06_line_webhook.py
功能：接收用戶回覆 → AI 自動判斷意圖 → 更新跟進狀態
執行：python 06_line_webhook.py  （需保持運行）
外部存取：建議搭配 ngrok（免費）對外開放 Webhook URL
"""
